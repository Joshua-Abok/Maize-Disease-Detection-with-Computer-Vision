...
print(f"this is the basedir: {BASE_DIR}")
model = load_model(os.path.join(BASE_DIR+'/artifacts/training/', 'model.h5'))
...
classes = ['healthy', 'leaf_blight', 'leaf_curl', 'stalk_borer']
