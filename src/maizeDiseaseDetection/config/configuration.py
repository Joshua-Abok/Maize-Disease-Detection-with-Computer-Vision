...
from src.maizeDiseaseDetection.entity.config_entity import (DataIngestionConfig, PrepareBaseModelConfig)
...
class ConfigurationManager: 
    def __init__(
        ...
        #prepare data initial configuration 
    def get_data_ingestion_config(self) -> DataIngestionConfig:   # return type of func: DataIngestionConfig
